...
ARG SPARK_URL="https://apache.mirror.digitalpacific.com.au/spark/spark-3.0.1/spark-3.0.1-bin-hadoop2.7.tgz"
...
RUN tar zxf spark.tgz && mv spark-* /usr/local/spark && rm spark.tgz
RUN tar zxf hadoop.tgz && mv hadoop-* /usr/local/hadoop && rm hadoop.tgz
